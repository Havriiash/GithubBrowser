...
class UserDetailStarredFragment : BaseListFragment<IShortRepoInfo, UserRepository>() {
    ...
    override val dataSource: BaseListDataSource<IShortRepoInfo, UserRepository>
